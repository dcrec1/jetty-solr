...
--------------------
New Relic RPM is a application performance monitoring service that lets you see 
...
set of methods.  The metrics are reported to the RPM service once a minute.  The agent also
...
If you don't already have a New Relic RPM account creating one is easy: http://www.newrelic.com/get-RPM.html.
...
at: http://support.newrelic.com/faqs/docs/java-agent-installation
...
That's all you need to do.  Start your application server with the -javaagent parameters and log in to NewRelic RPM
to see your app's performance information.  It takes about 2 minutes for the application data to show up
in RPM (http://rpm.newrelic.com).  By default, your data will appear under an application named 
...
The New Relic Java agent uses code from the following open source projects under the following licenses:
    ...
    Apache Commons CLI    http://commons.apache.org/cli/                   http://www.apache.org/licenses/LICENSE-2.0.html
    org.JSON              http://www.json.org/java/index.html              http://www.json.org/license.html
